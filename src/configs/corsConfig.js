...
const allowedOrigins = isProduction
  ? [process.env.PRODUCTION_ORIGIN || process.env.PRODUCTION_ORIGIN].filter(Boolean)
  : [process.env.LOCAL_ORIGIN || 'http://localhost:5173', process.env.PRODUCTION_WORKSPACE_ORIGIN].filter(Boolean);
